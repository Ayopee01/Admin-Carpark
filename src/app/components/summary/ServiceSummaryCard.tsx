...
function ServiceSummaryCard({ items, totalAmount }: Props) {
    return (
        <article className="rounded-[18px] bg-[#E4E6E8] p-5 md:p-6">
            ...
            <div className="mt-5 space-y-4">
                {items.map((item) => (
                    <div
                        key={item.id}
                        className="grid grid-cols-[40px_minmax(0,1fr)_auto] items-start gap-3"
                    >
                        <div className="flex h-10 w-10 items-center justify-center rounded-[8px] bg-[#F7F7F8] text-[#1F2937]">
            ...
            <div className="mt-6 border-t border-[#CDD2D8] pt-5">
                <div className="flex items-end justify-between gap-3">
                    ...
                    <span className="text-[28px] font-extrabold leading-none text-[#1F2937]">
